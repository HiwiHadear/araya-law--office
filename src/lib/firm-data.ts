...
export const LAWYERS: Lawyer[] = [
  ...
  },
  {
    ...
    bio: "Selamawit advises individuals and employers on sensitive family, employment, and property matters, with a practice grounded in discretion and careful negotiation.",
