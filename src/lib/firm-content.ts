...
const ZH_LAWYERS: Record<string, Partial<Lawyer>> = {
  ...
  "chen-wei": {
    name: "陈伟",
    role: "助理律师",
    qualifications: "法学学士、法学硕士，法律实务与程序文凭",
    bio: "陈伟律师代理刑事诉讼与监管事务，并办理移民、居留及国籍申请，尤其为在埃塞俄比亚的华语客户与中资企业提供法律服务。",
    education: ["中国政法大学 法学硕士", "亚的斯亚贝巴大学法学院 法学学士"],
    experience: ["一审及上诉阶段刑事案件辩护律师", "在行政机关面前提供监管事务代理", "为中资企业提供移民、居留与合规顾问服务"],
  },
